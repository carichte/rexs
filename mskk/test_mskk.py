...
f1 = et.lorentzian_filter1d(f1, 1)
f2 = et.lorentzian_filter1d(f2, 1)
#f1kk = mskk.real(newE, f2)


pl.plot(newE, f1func(newE), linewidth=1.5)
pl.plot(newE, f2)
...
pl.plot(newE, f2)
pl.plot(newE, f1func(newE))
#pl.plot(Ekk, f1kk, "-", label="with %i anchors"%len(anchors))

#Ekk2, f2kk = mskk.imag(Ekk, f1kk)
Ekk2, f2kk = mskk.imag(newE, f1func(newE))
pl.plot(Ekk2, f2kk, label="without anchors")
#Ekk2, f2kk = mskk.imag(Ekk, f1kk, anc_om=anchors, anc_im=f2func(anchors))
Ekk2, f2kk = mskk.imag(newE, f1func(newE), anc_om=anchors, anc_im=f2func(anchors))
